// Arreglo de Regiones y Comunas, Se usa en Registro.html y en USUARIOS/Usuario.html
const regiones = [
  {
...
const vehiculos = [
  {
    ...
    categoria: "Compacto",
    disponible: true,
    imagen: "../IMG/T002REPRIJS_Yaris-Hybrid-MJ26.PNG",
  },
  {
    id: 2,
    nombre: "Suzuki Swift",
  ...
  },
  {
    ...
    kilometraje: 88000,
    categoria: "Sedán",
    disponible: false, //Este auto ya está en manos de otro chofer
    imagen: "../IMG/retail-chevrolet-sail-hb.png",
  },
];
...
// Logica para cargar comunas de manera dinamica (Select dependiente Región -> Comuna)
...
// logica para pintar la flota en el Inicio.html y Producto.html (Se eliminó la lógica de "carrito" porque no es una tienda)
...
// Funcion para guardar datos en LocalStorage, en lugar de un carrito de compras, guardaremos las "Actas en Proceso".
